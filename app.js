...
app.get("/movies/", async (request, response) => {
  ...
  const getMovieNamesQuery = `
    SELECT movieName FROM moviesData;`;
...
app.post("/movies/", async (request, response) => {
  ...
  const postMovieDetails = `INSERT INTO moviesData(directorId,movieName,leadActor)
...
app.get("/movies/:movieId/", async (request, response) => {
  const { movieId } = request.params;
  const getMovieIdQuery = `SELECT * from moviesData WHERE movieId=${movieId};`;
...
app.put("/movies/:movieId/", async (request, response) => {
  const { directorId, movieName, leadActor } = request.body;
  const { movieId } = request.params;
  const updateMovieDetailsQuery = `UPDATE moviesData SET director_id=${directorId},movie_name='${movieName}',lead_Actor='${leadActor} WHERE movieId=${movieId};`;
...
app.delete("movies/movieId/", async (request, response) => {
  const { movieId } = request.params;
  const deleteMovieQuery = `DELETE moviesData WHERE movieId=${movieId};`;
...
app.get("/directors/", async (request, response) => {
  ...
  const getDirectorDetailsQuery = `SELECT * FROM moviesData WHERE directorId=${directorId};`;
...
app.get("/directors/:directorId/movies/", async (request, response) => {
  ...
  const getMovieNameQuery = `SELECT * FROM moviesData WHERE directorId=${directorId};`;
